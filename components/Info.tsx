...
const WhatsAppIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 group-hover:text-[#25D366]">
    ...
    return ( 
        <div>
            ...
            <div className="mt-10 flex items-center gap-x-3">
                <Button className="group flex items-center gap-x-2 hover:opacity-99">
                    Consultar
                    <WhatsAppIcon />
                </Button>
            </div>
